...
//     return (
//         <>
//         <div className="second-div" style={{ width: "18rem" }}>
//       <p>Suggestions</p>
//       <div className="friend-card bs-body-font-family">
//         <img src="/images/profile.png" alt="Profile Picture" />
//         <p className="friend-name" style={{ marginTop: "10px" }}>
//           Dianne Russell
//           <br />
//           <span className="friend-address">Sheikh Zayed Road</span>
//         </p>
//       </div>
//       <div className="friend-card bs-body-font-family">
//         <img src="/images/profile.png" alt="Profile Picture" />
